...
<%@page import="com.togetdog.adoption.AdoptionService"%>
            ...
            <div class="col-lg-8 posts-list">
               <div class="single-post">
                  <div class="feature-img">
                     <img class="img-fluid" src="${vo.popFile }" alt="">
                  </div>
               ...
               <div class="comment-form">
                  ...
                  <form class="form-contact comment_form" id="insert_frm" action='<%=HR_PATH %>/view/adop.do' method="post" >
                     ...
                     <input type="hidden" name="desertion_no" value="${vo.desertionNo }" id="desertion_no" />
