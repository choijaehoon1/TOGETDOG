...
<body>
  ...
  <section class="contact-section section_padding">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="contact-title" id="loginTitle">비밀번호 찾기</h2>
        </div>
        <div class="col-lg-8">
          <form   name="searchpw_frm" action="/SOMAC/view/member.do" id="searchpw_frm"  method="post"  >
             <input type="hidden" name="work_div" value="do_selectOnePw" id="work_div" />
            <div class="row">
              <div class="col-12">
              </div>
              <div class="col-sm-9">
            ...
            <div class="form-group mt-3">
            	<input class="btn btn-primary" type="button" id="pwfind_btn"  value="찾기"  >
  ...
  <script src="js/main.js"></script>
    ...
    $("#pwfind_btn").on('click',function(){
         ...
         if(false == confirm(member_id+"로)\찾으시겠습니까?")) return;
       ...
       //ajax
         ...
         success:function(data){   //성공
            ...
            alert("아이디와 이름를 정확히 입력하세요." + error);
