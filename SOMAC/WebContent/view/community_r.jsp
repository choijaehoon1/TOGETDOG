...
<%@page import="com.togetdog.community.CommunityService"%>
...
<%
	...
	List<JoinVO> recentList =(List<JoinVO>)request.getAttribute("recentList");
...
<body>
  ...
  <section class="blog_area section-padding">
                    ...
                    <div class="blog_right_sidebar">
                        <aside class="single_sidebar_widget search_widget">
                                ...
                                <button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn"
                                    type="button" onclick="javascript:doRRetrieve();" id="to_list_btn">Search</button>
                        ...
                        <aside class="single_sidebar_widget post_category_widget">
                            ...
                            <ul class="list cat-list subTitle">
                                <li>
                                    <a href="/SOMAC/view/community.do?work_div=do_retrieve">종합커뮤니티</a>
                                </li>
                                <li>
    ...
    <script type="text/javascript">
    	...
    	function doRRetrieve(){
    		var frm = document.searchFrm;
			frm.work_div.value ="do_retrieve_r";
...
//			alert("seq:" + seq);
			...
			var frm = document.searchFrm;
			frm.work_div.value ="do_selectOne_r";
			frm.seq.value = seq;
