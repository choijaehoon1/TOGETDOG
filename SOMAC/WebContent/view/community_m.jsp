...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="bradcam_text text-center">
                                <h3 id="communityTitle">목격자를 찾습니다</h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="blog_right_sidebar">
                        <aside class="single_sidebar_widget search_widget">
                                ...
                                <button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn"
                                    type="button" onclick="javascript:doMRetrieve();" id="to_list_btn">Search</button>
                        ...
                        <aside class="single_sidebar_widget newsletter_widget">
                            <h4 class="communityTitleFont">게시글 등록</h4>
                                ...
                                <button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn"
                                    type="button" onclick="javascript:moveToSave();" id="insert_btn">등록하기</button>
    ...
    <script type="text/javascript">
	    ...
	    function doMRetrieve(){
    		var frm = document.searchFrm;
			frm.work_div.value ="do_retrieve_m";
